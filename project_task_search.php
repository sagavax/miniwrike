...
$searched_text = $_GET['searched_text'];

$get_tasks_by_text = "SELECT * from project_tasks WHERE task_name LIKE '%".$searched_text."%' ORDER BY task_id DESC";
//echo $get_tasks_by_status;
$result = mysqli_query($db, $get_tasks_by_text) or die("MySQL ERROR: " . mysqli_error());
