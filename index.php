      	...
      	<!-- <div class="logged_user">Tomas Misura</div> -->
		    ...
		    <div id="add_project"> <!--- add task -->
						<form accept-charset="utf-8" method="post" action="index.php">
		                    	<button type="submit" name="add_new_project" class="blue-badge-large">+ Project</button>
                                <div id="projects_filter"><select name="show_projects_status">
                                   <option value="active">Active</option>
                                   <option value="all">All</option>
                                </select><button name="show_projects" type="submit" class="blue-badge">OK</button></div>
						</form>
