...
if($sort==="asc") {
	$get_assigned_people = "SELECT *  FROM project_users ORDER BY user_id ASC";

} elseif ($sort=="dsc"){
	$get_assigned_people = "SELECT *  FROM project_users ORDER BY user_id DESC";
} else {
	$get_assigned_people = "SELECT *  FROM project_users ORDER BY user_id";
