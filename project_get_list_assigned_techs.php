<?php
	...
	$get_latest_tech = "SELECT a.id, a.tech_id, b.tech_id, b.technology_name FROM project_assigned_technologies a JOIN project_technologies b ON a.tech_id = b.tech_id WHERE a.project_id = $project_id ORDER BY a.id";
