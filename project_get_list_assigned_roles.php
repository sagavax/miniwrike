<?php
	...
	$get_latest_role = "SELECT a.id,a.role_id, b.role_id, b.role_name FROM project_assigned_roles a, project_roles b WHERE a.project_id=$project_id AND a.role_id = b.role_id ORDER BY a.id DESC";
