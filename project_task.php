...
if (isset($_POST['add_task_subtask'])) { //pridanie subtasku
    ...
    /*
        ...
        task_id int(11) Auto Increment   
        project_id  int(11)  
        parent_id   int(11) [0]  
        user_id int(11)  
        project_phase   varchar(30) NULL    faza projektu, pre ktoru bol ten task vytvoreny
        task_name   text NULL   Text
        task_description    text NULL    
        status  varchar(20)  
        task_priority   varchar(10)  
        is_completed    int(11) NULL     
        task_created    date    Datum kedy bolo vytvorene
        task_finished   date    darum ukoncenia tasku
        task_deadline
    ...
    */
    ...
    $sql1 = "INSERT INTO project_tasks (project_id, parent_id, user_id, task_description,task_status, task_priority, task_created, task_finished, task_deadline) VALUES ($task_id,$project_id, $user_id,'$task_name', 'new','normal','$date_added','','$task_deadline')";
