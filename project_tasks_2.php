					...
					<?php
						...
						while ($row = mysqli_fetch_array($result)) {
							...
							//echo "<tr class='$color' id='".$id."'>";
								echo "<tr id='".$id."'>";
									echo "<td style='width: 600px'><a href='project_task.php?task_id=$id&project_id=$project_id&user_id=1'>$note_text</a></td><td><div class='status_badge'>$priority</div></td><td><div class='status_badge'>
                  ".NrOfSubtasks($id)."
